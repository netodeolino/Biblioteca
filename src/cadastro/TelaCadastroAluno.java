...
public class TelaCadastroAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMatricula.setFont(new java.awt.Font("Ubuntu", 0, 17)); // NOI18N
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        String matriaux = txtMatricula.getText();
        int novomatri = Integer.parseInt(matriaux);
        ...
        Aluno a = new Aluno();
        a.setCpf(cpfaux);
        a.setMatricula(novomatri);
        
        RepositorioAluno repA = new AlunoDAO();
        repA.cadastrarAluno(a);
